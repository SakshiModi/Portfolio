...
export const portfolioData = {
  hero: {
    ...
    tagline: 'Backend Engineer with 4+ years in Python & Java. Built systems saving $8M+ quarterly. AWS Certified · LeetCode Knight.',
    openTo: 'Open to Backend · Platform · Full-Stack Engineering roles',
  ...
  experience: [
    {
      ...
      bullets: [
        ...
        'Deployed <strong>Python scripts on AWS Lambda</strong> to automatically update documents in S3, leveraging data from RDS.',
        'Automated SQL query generation from Excel/S3 files, <strong>saving 50+ hours per release</strong> and eliminating manual QA work.',
      ...
      tags: 'Java,Python,Flask,SQL,AWS Lambda,AWS S3,Amazon RDS,REST APIs,LLMs,Docker,Jenkins',
    },
    {
      ...
      bullets: [
        'Developed Java modules on JBoss in Agile SDLC, creating APIs that reduced analysis time to <strong>under 30% of baseline</strong>.',
        'Improved <strong>duplicate record detection accuracy by 93%</strong>, strengthening platform data integrity.',
        'Managed object-oriented backend with optimized SQL queries; handled 25+ defects via BitBucket version control.',
      ],
    ...
    },
    {
      ...
      bullets: [
        ...
        'Led AWS migration using <strong>EventBridge, Lambda, RDS and QuickSight</strong>, improving system scalability.',
        'Mentored new engineers via knowledge transfer sessions; received the <strong>On the Spot Award</strong> from the client.',
      ],
      tags: 'AWS,Python,Flask,SQL,Tableau,HTML,CSS,Bootstrap,JavaScript',
    },
    {
      ...
      tags: 'Python,TensorFlow,YOLO,Neural Networks,SQL',
    },
  ],
  ...
  projects: [
    {
      ...
      tags:   'Java,PL/SQL,Oracle DB,REST APIs',
      github: '',
    },
    {
      ...
      tags:   'Python,LLMs / GPT,AWS S3,PostgreSQL',
      github: '',
    },
    {
      ...
      tags:   'Python,SQL,AWS S3,Jenkins,Git',
      github: '',
    },
    {
      ...
      tags:   'Python,Flask,MySQL,Docker,REST APIs',
    ...
    },
    {
      ...
      tags:   'Python,TensorFlow,Neural Networks,Image Processing',
      github: '',
    },
    {
      ...
      tags:   'Python,Keras,RNN,LSTM,Deep Learning',
